...
- `Security_Overlay_Toolkit.ajs` is the preferred bundled entry point for daily use.
- `Build_Security_Overlay_Library_With_Overlay_Model_Folder.ajs` builds the general Security Overlay library with the Overlay Model folder structure.
